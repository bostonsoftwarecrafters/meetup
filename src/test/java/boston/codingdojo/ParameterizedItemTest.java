...
//TODO Copy tests from other product types into our data array
    ...
    public static Iterable<Object[]> data() {
        return (Arrays.asList(new Object[][]{
                ...
                {"AgedBrie quality +2 when expires", GildedRose.PRODUCT_AGED_BRIE, 0, -1, 41, 43},
                {"AgedBrie quality +2 after expiry date", GildedRose.PRODUCT_AGED_BRIE, -2, -3, 46, 48},
                {"Backstage passes over ten days, increases by one", GildedRose.PRODUCT_BACKSTAGE_PASSES, 11, 10, 46, 47},
                {"Backstage passes at ten days, increases by two", GildedRose.PRODUCT_BACKSTAGE_PASSES, 10, 9, 46, 48},
                {"Backstage passes at five days, increases by three", GildedRose.PRODUCT_BACKSTAGE_PASSES, 5, 4, 46, 49},
                {"Backstage passes at one day, increases by three", GildedRose.PRODUCT_BACKSTAGE_PASSES, 1, 0, 46, 49},
                {"Backstage passes at zero days, drops to zero", GildedRose.PRODUCT_BACKSTAGE_PASSES, 0, -1, 46, 0},
