	...
	public static Iterable<Object[]> data() {
		return(Arrays.asList(new Object[][] {
			// description, product, initial daysToExpire, expected daysToExpire, initial quality, expected quality
				...
				{"PRODUCT_BACKSTAGE_PASSES quality +2 when from 10 to 9", GildedRose. PRODUCT_BACKSTAGE_PASSES, 10, 9, 20, 22},
				{"PRODUCT_BACKSTAGE_PASSES quality +3 when from 4 to 3", GildedRose. PRODUCT_BACKSTAGE_PASSES, 4, 3, 20, 23},
				{"PRODUCT_BACKSTAGE_PASSES quality to 0 when from 0 to -1", GildedRose. PRODUCT_BACKSTAGE_PASSES, 0, -1, 20, 0}
